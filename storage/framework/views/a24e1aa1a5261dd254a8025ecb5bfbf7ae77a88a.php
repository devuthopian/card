...
<body onload="sizing()" onresize="sizing()">
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <div class="row blocks">
                <!-- Edit Profile -->
                <?php echo $__env->make('users.profile.partials.profiles', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <!-- Edit Profile -->
    <?php echo $__env->make('users.profile.partials.newProfilePopup', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

</body>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('scripts'); ?>
<script src="<?php echo e(asset('js/users/profile/myProfiles.js')); ?>"></script>
<?php $__env->stopSection(); ?>
