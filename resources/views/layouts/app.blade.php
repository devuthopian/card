...
<head>
    ...
    <!-- Tagged input -->
    <link rel="stylesheet" href="{{ URL::asset('assets/bootstrap-tagsinput/bootstrap-tagsinput.css') }}" />
...
<body>
    ...
    <script src="{{ URL::asset('assets/bootstrap-tagsinput/bootstrap-tagsinput.min.js') }}"></script>
